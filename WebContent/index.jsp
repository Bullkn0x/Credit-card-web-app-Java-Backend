...
<form class ="form" action="transactionbyzip">
  Enter Zipcode<br><br>
  <input type="text" name="zipcode" placeholder="39120">
  <br><br>

  <p>
  <label for="start"></label>
  <input id="start" type="month" value= "Month Year" name="date">
  </p>
...
<form class="form" action="transactionbetweendates">
	...
	<input type="text" name="cardNumber" placeholder="Enter Credit Card Number">
  	<br><br>
  	Enter Last 4 of your SS:
	<input type="text" name="ssn" placeholder="1234">
  	<br><br>
   <p>
    <label for="start">Starting Date</label>
    <input id="start" type="date" name="startDate" min="2018-01-01" required pattern="[0-9]{4}-[0-9]{2}-[0-9]{2}" />
    <span class="validity"></span>
  </p>
  <p>
    <label for="end">Ending Date</label>
    <input id="end" type="date" name="endDate" max="2025-12-31" required pattern="[0-9]{4}-[0-9]{2}-[0-9]{2}" />
    <span class="validity"></span>
  </p>
  <input class="submit" type="submit" value= "Submit">
</form> 
